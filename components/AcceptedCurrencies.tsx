...
const CurrencyItem: React.FC<{ currency: CryptoCurrency }> = ({ currency }) => (
    <div className="flex items-center space-x-4 bg-brand-navy/80 border border-yellow-900/40 px-6 py-3 rounded-xl mx-4 flex-shrink-0 transition-all duration-300 hover:scale-110 hover:border-brand-gold/60 hover:bg-brand-navy shadow-lg">
        {currency.icon}
    ...
    <section id="currencies" className="py-20 sm:py-24 overflow-hidden">
      <div className="container mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">
            Flexible Loan Payouts in <span className="text-brand-gold">15+ Major Currencies</span>
        </h2>
