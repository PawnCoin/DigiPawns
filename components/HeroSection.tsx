    ...
    <section className="text-center py-20 sm:py-24 lg:py-32">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold tracking-tighter leading-tight">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-gold to-brand-gold-light"> Digital Assets</span>
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a 
            ...
            className="bg-brand-gold text-brand-dark font-bold py-4 px-10 rounded-lg text-lg hover:bg-brand-gold-light transition-all duration-300 shadow-gold-glow transform hover:scale-105"
          >
