          ...
          <div className="flex items-center gap-2">
            ...
            {isWalletConnected ? (
              isCorrectChain ? (
                ...
                <>
                  {/* Mobile: compact red dot button */}
                  <button
                    onClick={switchToCorrectChain}
                    title="Wrong network — tap to switch"
                    className="flex sm:hidden items-center justify-center w-8 h-8 rounded-lg border border-red-700/50 bg-red-900/20 text-red-400 hover:bg-red-900/40 transition-colors"
                  >
