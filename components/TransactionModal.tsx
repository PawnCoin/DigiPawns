                    ...
                    <>
                        ...
                        <div className="mt-6 space-y-3 bg-brand-dark/50 p-4 rounded-lg">
                            ...
                            <div className="flex justify-between text-sm pt-2 border-t border-yellow-900/30 mt-2">
                                ...
                                <span className="font-bold text-lg text-brand-gold">${loanTerms.repaymentAmount.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
                            </div>
                        </div>
                        <button onClick={handleStartTransaction} className="w-full mt-6 bg-brand-gold text-brand-dark font-bold py-3 px-6 rounded-lg text-lg hover:bg-brand-gold-light transition-all">
                            Proceed in Wallet
                        </button>
                    </>
                );
            ...
            case 'success':
                 return (
                    <div className="text-center">
                        ...
                        <button onClick={onClose} className="w-full mt-6 bg-brand-gold text-brand-dark font-bold py-2.5 px-6 rounded-lg hover:bg-brand-gold-light">
                            View My Dashboard
                        </button>
                    </div>
                );
