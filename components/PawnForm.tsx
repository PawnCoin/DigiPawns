                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-brand-navy p-8 rounded-2xl shadow-2xl border border-yellow-900/40">
                        ...
                        <form onSubmit={handleAppraise}>
                            ...
                            <button type="submit" disabled={isLoading} className="w-full btn-metallic-gold py-3 px-6 rounded-lg text-lg disabled:!bg-gray-600 disabled:!text-gray-400 disabled:cursor-not-allowed disabled:shadow-none disabled:[animation:none] flex items-center justify-center">
                                {isLoading ? (
                                    <>
